                                            ...
                                            <div class="checkout_item_container thead">
                                                ...
                                                <div class="checkout_item_details">
                                                    <div class="item_data_wrapper_row title">
                                                        ${order["product_details"]?.[0]?.["units"] ? `<div class="item_data">${locale["labels"]["estPrice"]}</div>` : ''}
                                                        ...
                                                        ${order["product_details"]?.[0]?.["discount"] ? `<div class="item_data">${locale["labels"]["onInvoiceDiscount"]}</div>` : ''}
                ...
                <tr>
                    <td>
                        <div class="checkout_item_container">
                            <div class="checkout_item_name inverted">
                                <div class="item_name_text">
                                    ${item["name"]}
                                </div>
                            </div>
                            <div class="checkout_item_details inverted">
                                <div class="item_data_wrapper_row">
                                    ${item["price"] ? `<div class="item_data">€ ${item["price"] && item["price"] !== "null" ? item["price"] : "-"}</div>` : ''}
                        ...
                        <div class="counter__wrapper">
                            <div class="counter__container" skudata="${productData["sku"]}" parentskudata=${data["sku"]} _id=${data["_id"]}>
                                ...
                                <div class="addmore__qty searchbox">
                                    <div class="submit">
                                        <img src="/gskPortugalPhase2/assets/images/svg/icons8-ok.svg" />
                                    </div>
                                </div>
                            </div>
                        </div>

        ...
        "brands": [
            {
                ...
                "on_invoice_range": [
                    ...
                    { "discount": "10", "label": "4" },
                    { "discount": "15", "label": "6" },
                    { "discount": "20", "label": "10" },
                    { "discount": "25", "label": "20" }
                ],
                "off_invoice_range": [
                    { "discount": "0", "label": "2" },
                    { "discount": "10", "label": "4" },
        ...
        "brands": [
            {
                ...
                "on_invoice_range": [
                    { "discount": "0", "label": "8" },
                    { "discount": "10", "label": "16" },
                    { "discount": "15", "label": "24" },
                    { "discount": "20", "label": "40" },
                    { "discount": "25", "label": "80" }
                ],
                "off_invoice_range": [
                    { "discount": "0", "label": "8" },
                    { "discount": "10", "label": "16" },
        ...
        "orders": [
            {
                ...
                "_id": "8fa7c337-c438-430e-9f45-4fee55bc1fd8",
                "brandsku": "GSK-ACCOUNT_NO-A0001-GSK-BRAND-AUGMENTIN",
                "ordered_date": "Nov 17, 23"
            }
        ]
    },
    "appstate": {
        ...
        "updateCartData": {},
        "cartData": {
            "GSK-ACCOUNT_NO-A0001_70451df7-c2cb-42e0-a685-0125ab536f3f": {
        ...
        "wholesalerAccountData": [
            {
                ...
                "_id": "70451df7-c2cb-42e0-a685-0125ab536f3f",
                "brandsku": "GSK-ACCOUNT_NO-A0001-GSK-BRAND-AUGMENTIN",
                "ordered_date": "Nov 17, 23"
            }
        ],
...
function CallScreen(caseNum) {
    switch (String(caseNum)) {
        ...
        case "1":
            ...
            break;
        case "2":
            ToApp("userwelcome-screen", base);
            break;
        case "3":
            ToApp("userwelcome-screen", base2);
            break;
        case "4":
            ToApp("userwelcome-screen", base3);
            break;
        case "5":
            ToApp("userwelcome-screen", base4);
            break;
        case "20": 
